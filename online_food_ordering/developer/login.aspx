<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="online_food_ordering.developer.login" %>
...
<head runat="server">
  ...
  <title>Food Ordering Developer Login</title>
  <!-- plugins:css -->
        ...
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <h4 class="font-weight-light" style="text-align: center;">Developer</h4>
