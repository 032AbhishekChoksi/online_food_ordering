				...
				<div class="card-body">
					<form id="fo1" runat="server" class="forms-sample" method="post" enctype="multipart/form-data">
						<div class="form-group">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidatorcategory_id" runat="server" Style="color:#e02c2b;" ErrorMessage="RequiredFieldValidator" ControlToValidate="ddtcategory_id" Display="Dynamic" >Category is mandatory </asp:RequiredFieldValidator>
						</div>
						<div class="form-group">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidatordish" runat="server" Style="color:#e02c2b;" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtdish" Display="Dynamic" >Dish is mandatory </asp:RequiredFieldValidator>
						...
						<div class="form-group">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidatortype" runat="server" Style="color:#e02c2b;" ErrorMessage="RequiredFieldValidator" ControlToValidate="ddttype" Display="Dynamic" >Type is mandatory </asp:RequiredFieldValidator>
						</div>
						<div class="form-group">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidatordish_detail" runat="server" Style="color:#e02c2b;" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtdish_detail" Display="Dynamic" >Dish detail is mandatory </asp:RequiredFieldValidator>
						</div>
						<div class="form-group">
								...
								<ItemTemplate>
									<div class="row mt8">
										<div class="col-4">
											...
											<input type="text" class="form-control" placeholder="Attribute" name="attribute" required value="<%# Eval("attribute") %>">
										</div>
										<div class="col-3">
